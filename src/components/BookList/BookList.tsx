...
import { trackButtonClick } from "../../utils/metricsService";
...
const BookList: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const baseURL = `${import.meta.env.VITE_API_BASE_URL}:${import.meta.env.VITE_API_PORT}/ws/books`;
  ...
  const handleSubmit = (book: Book | null): void => {
    ...
    const action: Promise<AxiosResponse<void,Book>> = book.id
